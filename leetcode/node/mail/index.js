...
async function sendMail(words) {
  let user = "754211506@qq.com"
  let pass = "cmewzsejxmhpbbaa"; //  授权码
  let to = "342435112@qq.com";
...
//sendMail();
schedule.scheduleJob({hour:15,minute:40},function(){
