<template>
 <div>
  <header class="home-header wrap"  :class="{active: headerScroll}">
      ...
      <router-link class="login" tag="span" to="/user" v-else><i class="iconfont icon-User"></i></router-link>
  ...
  <!-- 分类列表 -->
    ...
    <!-- 热门商品 -->
    <goodsList :goods="hotGoodses" :title="'热门产品'" />
    <!-- 最新推荐 -->
