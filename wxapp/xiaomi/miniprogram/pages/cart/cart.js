...
Page({
   ...
   */
  data: {
    carticon:'https://github.com/linzhiyuan00/xiaomiLite/blob/5-13/images/cart/icon1.png',
    kongtip:'购物车还是空的',
  ...
  topay() {
    let newPayItem = this.data.cartlistDetail;
    app.isNotRepeteToCart(newPayItem)
    wx.switchTab({
      url: '/pages/pay/pay',
    })
  },
